...
import styles from './cityOfficials.module.css'; // Importing custom styles
...
const CityOfficials = () => {
  ...
  <div>
    <Navbar /> 
      ...
      <footer className={`border-top mt-5 py-4 text-center ${styles.footer}`}>
        <img 
          src='https://storage.googleapis.com/a1aa/image/essSeWmNC9N6rtIoiDajhhqhrKSiedHPc6oOiY6toNQ.jpg'
          alt="State emblem" 
